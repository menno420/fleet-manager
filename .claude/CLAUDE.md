...
1b. **The owner's CURRENT plan — read before the program below:**
   ...
   § 4.8's fresh-agent test run 2026-08-12, fm #851 — PARTIAL near-PASS) · the
   common operating protocol (not started). **This entry exists because the roadmap appeared in neither this file
