...
> **Status:** `reference`
>
> Generated by substrate-kit — originally. **Scope: this file covers only the
> kit-shipped half of the skill set** (10 rendered rows); the complete installed
> roster — all 27, both halves, one line each — is
> [`SKILLS-local.md`](SKILLS-local.md), which also explains the split. **NOT
