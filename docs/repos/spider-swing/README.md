...
| [`working-here.md`](working-here.md) | **kept — ratified 2026-08-09.** Gates, verify commands and conventions are what a session needs *before* attaching, and they are neither state nor goals. Proposed here as a new shape; the owner kept it distinct, so it is part of what every folder replicates |
