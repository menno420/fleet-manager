...
| [`working-here.md`](working-here.md) | **kept, and proposed as a new shape** — gates, verify commands and conventions are what a session needs *before* attaching, and they are neither state nor goals. **This is an open question for the owner**, not a settled decision |
