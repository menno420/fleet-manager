...
| **2** | `spider-bot` | ◐ **entry point built** 2026-08-24 (on-demand, the registration session — the repo went live the same day) — `README.md` only; depth files not yet written, reasons in its header. Carries the § 5.7 section (nulls; Railway + Developer Portal named as the operational venues) |
