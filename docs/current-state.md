...
- **couch-legend created — the Grok one-prompt game adopted, live on Pages**
  (2026-08-20, fm #870): `idle-stoner.grok.me` reconstructed from its deployed
  bundles into an owned repo — tested engine, faithful tuning, additive
  improvements, `docs/DESIGN.md` as the decided mechanics map, Android path
  chosen (Capacitor). Live: <https://menno420.github.io/couch-legend/>.
