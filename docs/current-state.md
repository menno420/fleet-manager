...
- **couch-legend — adopted (fm #870); phase 2 (#1); looks pass (#3 Lucid
  Chronicle, #4); kit-seeded v1.21.0 (#5, fm #879); the life story LANDED
  (#7 — adopted tuning · save v2 `lifeHigh` · 18 chapters, 3 scenes live ·
  rails re-checked); Android shell next**
  (2026-08-20/21): [`repos/couch-legend/README.md`](repos/couch-legend/README.md).
