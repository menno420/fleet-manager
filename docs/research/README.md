...
| 2026-07-12 | [Platform capability & limitation ledger](2026-07-12-platform-capabilities.md) | The seat-era claude.ai Projects/sessions capability snapshot — era-noted 2026-08-11: several walls since refuted ("GitHub is MCP-only" among them); the live ledger is `docs/CAPABILITIES.md` + the boot file. *(Row added 2026-08-11, audit D90/D91 — this and the two rows below were merged and tracked but absent from this index, which its own contract reads as "not merged".)* |
| 2026-07-12 | [Problem census — satellite repos](2026-07-12-problem-census-satellites.md) | The satellite half of the census night (badged `historical`): per-repo problem lists for the non-core repos, input to the v3 prompt set. *(Row added 2026-08-11, audit D90/D91.)* |
| 2026-07-12 | [Prompt architecture & steering](2026-07-12-prompt-architecture.md) | Requirements spec for the v3 prompt set (PR #95): steering findings and the structure the v3.x registry was built against. *(Row added 2026-08-11, audit D90/D91.)* |
