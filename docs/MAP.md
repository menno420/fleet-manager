...
| [`traps.md`](traps.md) | **CORE** | The trap register (D3 / roadmap § 5.4) — the estate's recurring **execution** mistakes in TRAP · TRIGGER · WHY · REQUIRED PREVENTION · VERIFY · ORIGIN form. You are not meant to read it at the moment you need it: five of its six entries are delivered by `doc-routes` at the point of action. CAPABILITIES records what the estate *can do*; this records what it keeps *getting wrong*. |
