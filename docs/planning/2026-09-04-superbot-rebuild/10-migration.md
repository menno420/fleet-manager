...
| **OD-F** — how much authority the AI holds | D2's write-capable floor (exactly one under the default) and D3's tier boundaries. **The pipeline order in `[D-0042]` is identical under every answer** |
