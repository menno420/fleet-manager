...
>
> generated-at 2026-08-11T18:01:58Z
>
> 57 idea block(s) across 350 card(s) · 4 ungroomed · 4 ungroomed older than 2d.

| Card date | Source card | Idea | Groom status |
|---|---|---|---|
| 2026-07-21 | `2026-07-21-fm-seat-close.md` | post-program, the single highest-leverage artifact would be a one-page "fleet resurrection… | groomed → `2026-07-26-fleet-consolidation-plan.md` |
...
| 2026-07-21 | `2026-07-21-fm-16z-cycle.md` | gate-red self-report. Add an `if: failure()` step to `substrate-gate.yml` that greps the s… | groomed → `2026-07-26-final-eap-email-plan.md` |
| 2026-07-21 | `2026-07-21-fm-0818z-cycle.md` | machine-readable posture fence | groomed → `2026-07-14-central-docs-plan.md` |
| 2026-07-21 | `2026-07-21-fm-0042z-cycle.md` | worker preflight script | groomed → `2026-07-26-consolidation-program.md` |
| 2026-07-20 | `2026-07-20-fm-morning-records.md` | I9 UNCOVERED-CHAIN | **ungroomed** ⚠ >2d |
| 2026-07-20 | `2026-07-20-fm-liveness-ledger.md` | `--streaks` mode over the ledger | groomed → `overnight-menu-2026-07-17.md` |
| 2026-07-20 | `2026-07-20-fm-declared-idle.md` | *idle-but-burning downshift advisory* — an `IDLE-DECLARED` lane whose failsafe keeps firin… | groomed → `2026-07-14-central-docs-plan.md` |
| 2026-07-20 | `2026-07-20-fm-1530z-cycle.md` | WAKE-NO-RECOVERY invariant | groomed → `2026-07-26-consolidation-program.md` |
| 2026-07-20 | `2026-07-20-fm-1130z-cycle.md` | I3b CHAIN-FIRED-OUT | groomed → `2026-07-19-next-slices.md` |
| 2026-07-19 | `2026-07-19-fm-wake-idle-detector.md` | WAKING-IDLE escalation → a paste-ready owner-queue burner item | groomed → `2026-07-19-next-slices.md` |
...
| 2026-07-19 | `2026-07-19-fm-regen-skip-detector.md` | regen run-history probe (`--probe-runs`) to name the drop's cause | groomed → `2026-07-26-consolidation-program.md` |
...
| 2026-07-19 | `2026-07-19-fm-evening-groom.md` | teach `gen_idea_backlog.py` a `shipped → scripts/<file>` status | groomed → `2026-07-26-consolidation-program.md` |
...
| 2026-07-16 | `2026-07-16-trigger-snapshot-pm.md` | teach `check_trigger_health.py` I8 DUPLICATE-CRON a *cutover-window* grace: when two enabl… | groomed → `2026-07-26-consolidation-program.md` |
...
| 2026-07-15 | `2026-07-15-triggers-snapshot-refresh-2.md` | the final-page inline gap above is a standing footgun for every snapshot refresh — a small… | groomed → `2026-07-26-fleet-consolidation-plan.md` |
| 2026-07-15 | `2026-07-15-session-ender-handoff.md` | ender-coherence guard | groomed → `2026-07-26-consolidation-program.md` |
...
| 2026-07-15 | `2026-07-15-retire-c61.md` | owner-queue asks born from a *seat-state* wall (STANDBY, trigger-less, quiet) should carry… | groomed → `2026-07-26-consolidation-program.md` |
| 2026-07-15 | `2026-07-15-registry-v3-5-synthesis.md` | index-generation sync guard | groomed → `overnight-menu-2026-07-17.md` |
| 2026-07-15 | `2026-07-15-queue-a63-next-triage.md` | parked-rail probe | groomed → `2026-07-26-consolidation-program.md` |
| 2026-07-15 | `2026-07-15-owner-queue-kit-go.md` | silently-stalled-seat probe | groomed → `2026-07-26-consolidation-program.md` |
...
| 2026-07-15 | `2026-07-15-lanes-regen-fix.md` | generation-parity guard — teach `scripts/check_roster_freshness.py` (or the strict gate) t… | groomed → `2026-07-26-consolidation-program.md` |
| 2026-07-15 | `2026-07-15-fleet-oversight-evening.md` | seat-staleness checker with seat-side-signal classification — a `scripts/check_seat_stalen… | groomed → `2026-07-26-consolidation-program.md` |
...
| 2026-07-14 | `2026-07-14-eap-final-ender.md` | make dormancy machine-detectable at wake time — teach the v3 startup/failsafe prompt templ… | groomed → `2026-07-26-consolidation-program.md` |
| 2026-07-14 | `2026-07-14-checklist-refresh-2.md` | `check_trigger_health.py` should accept a `--refresh-cmd-hint` or the wake procedure shoul… | groomed → `2026-07-26-consolidation-program.md` |
...
| 2026-07-12 | `2026-07-12-external-research-prompt.md` | the external-briefing compression done here by hand (research corpus → one self-contained … | groomed → `2026-08-08-agent-operating-environment-roadmap.md` |
| 2026-07-10 | `2026-07-10-registry-gap-closure.md` | registry drift checker | groomed → `2026-08-08-agent-operating-environment-roadmap.md` |
