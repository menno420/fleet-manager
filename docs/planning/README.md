...
| 2026-08-24 | [**Final EAP review mail — assembled draft**](2026-08-24-final-eap-email-draft.md) | Program step **E1**, assembled after the owner lifted the reservation live on 2026-08-24. The mail itself between COPY markers (Part 1 scaffold in his voice, Part 2 complete), the six decisions it makes so he can overturn each in one line, the four pre-send checks, and the after-send ledger updates. Spine: the month **after** the program, which is the half no other participant can send |
