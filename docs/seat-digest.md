...
- `any` · `owner-live` · **The agent proxy blocks GitHub API PATHS by allowlist, and the block is a JSON body from the proxy — not from GitHub.** Reads of…
- …plus 26 more — read `docs/CAPABILITIES.md`.
