...
- `autonomous-project` · **Self-scheduling the seat wake chain — WALL** (verified 2026-07-17). Neither the FM manager session nor the coordinator session exposes a usable…
- …plus 23 more — read `docs/CAPABILITIES.md`.
