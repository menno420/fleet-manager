...
- `autonomous-project` · **Auto-merge SQUASH RACE**: when no required checks are pending, SQUASH fires on the first green head before a trailing heartbeat commit can land — the…
- …plus 21 more — read `docs/CAPABILITIES.md`.
