...
<!-- char-count: 975 chars = the seat-block paste body below this comment block (headers excluded) · ASSEMBLY ACCOUNTING (v3.1): universal core 6,996 (custom-instructions-core.md CORE-START/END) + this block 975 = 7,971 vs 7,500 fitted / 8,000 hard · over fitted by 471, under hard — flagged -->
