...
<!-- char-count: 7,911 chars (7,992 UTF-8 bytes) = the paste body below this comment block (headers excluded) · HARD cap 8,000 chars AND bytes (verified console wall) · aim 7,500 · headroom 8 on the tighter basis -->

v3.5 websites CI — dictionary+router. DRIFT CHECK: quote this line on ask; older than fm:projects/websites/instructions.md = stale.
...
## Routes
CORE=fm:docs/prompts/v3/custom-instructions-core.md (riders) · UNIV=fm:projects/UNIVERSAL.md (owner grant; never edit) · STARTUP=fm:projects/websites/coordinator-prompt.md · ender=fm:docs/prompts/v3/session-ender.md. Deep-route: docs/AGENT_ORIENTATION.md -> CONSTITUTION.md.
