...
<!-- char-count: 7,946 chars (7,979 UTF-8 bytes) = the paste body below this comment block (headers excluded) · HARD cap 8,000 chars AND bytes (verified console wall) · aim 7,500 · headroom 21 on the tighter basis -->
