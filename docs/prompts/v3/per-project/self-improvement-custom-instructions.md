...
<!-- char-count: 7,908 chars (7,989 UTF-8 bytes) = the paste body below this comment block (headers excluded) · HARD cap 8,000 chars AND bytes (verified console wall) · aim 7,500 · headroom 11 on the tighter basis -->

v3.4 self-improvement CI — dictionary+router. DRIFT CHECK: quote this line on ask; older than fm:projects/self-improvement/instructions.md = stale.
