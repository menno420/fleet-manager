...
<!-- char-count: 7,966 chars (7,997 UTF-8 bytes) = the paste body below this comment block (headers excluded) · HARD cap 8,000 chars AND bytes (verified console wall) · aim 7,500 · headroom 3 on the tighter basis -->

v3.8 ideas-lab CI - dictionary+router. DRIFT CHECK: quote this line on ask; older than fm:projects/ideas-lab/instructions.md = stale.
