...
<!-- char-count: 7,897 chars (7,978 UTF-8 bytes) = the paste body below this comment block (headers excluded) · HARD cap 8,000 chars AND bytes (verified console wall) · aim 7,500 · headroom 22 on the tighter basis -->

v3.4 ideas-lab CI — dictionary+router. DRIFT CHECK: quote this line on ask; older than fm:projects/ideas-lab/instructions.md = stale.
...
- **claim** — one file in idea-engine control/claims/ (branch · scope · date) BEFORE work; stale only when branch/PR terminal at LIVE GitHub; claim-without-PR = LIVE; collision -> earlier-at-HEAD. -> CORE
