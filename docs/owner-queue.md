...
- **`OQ-E1-FINAL-EAP-EMAIL` — write and send the final EAP review email
  ...
  **▶ 2026-08-25 — THE REVISION PASS RAN AGAINST YOUR OWN CALLS. WHAT IS LEFT IS
  ...
  - **The length (§ 2 item 6): the literal cap.** Findings 1–3 and asks 1–5 only;
    ...
    **2,097 → 1,644 words.** *(The count is method-dependent and that was never
    ...
    words. The mail as pasted was **2,097** before his cut and is **1,644** now —
  ...
  **1,644 words is still about three pages, not one** — no route reached one page,
