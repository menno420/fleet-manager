...
| index drift | `scripts/check_estate_index.py` (advisory, selftest 13/13): folder↔row↔route-pair consistency, row↔folder identity, a declared row-count baseline, and a visible verified-stamp requirement |
