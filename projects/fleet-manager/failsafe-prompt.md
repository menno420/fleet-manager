...
# Fleet Manager — failsafe cron text (registry copy, prompts v3.6)
...
the predecessor heartbeat (control/status.md routine block) + telemetry/triggers-snapshot.json; plus ids the heartbeat marks left-for-successor. `list_triggers` is
