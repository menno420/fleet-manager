...
# SuperBot 2.0 — failsafe cron text (registry copy, prompts v3.7)
...
the predecessor heartbeat's routine block (possibly none live — verify, then act); plus ids the heartbeat marks left-for-successor. `list_triggers` is
