...
# SuperBot 2.0 — failsafe cron text (registry copy, prompts v3.2)
...
<!-- registry-header-end -->
# SuperBot 2.0 — failsafe cron (dead-man wake, Q-0265)

- **Routine name:** `SuperBot 2.0 failsafe wake`
- **cron:** `0 1-23/2 * * *` — slot per the v3.2 stagger table
...
the predecessor heartbeat's routine block (possibly none live — verify, never assume); plus ids the heartbeat marks left-for-successor. `list_triggers` is
