...
# SuperBot 2.0 — Custom Instructions (registry copy, prompts v3.7)
...
> char-count: 7,959 chars = the paste body below the marker, trailing
> newline excluded (CHARACTERS — the fleet budget basis; raw UTF-8 bytes
> 7,992) · hard cap 8,000 chars: PASS.
