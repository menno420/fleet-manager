...
# Game Lab — seat digest (registry render, extraction contract)
...
> - menno420/gba-homebrew/docs/seat-digest.md · sha256 a7d06d58de53 · venues=autonomous-project,any
> - menno420/pokemon-mod-lab/docs/seat-digest.md · sha256 2cc0c463747b · venues=autonomous-project,any

<!-- registry-header-end -->
## menno420/gba-homebrew — docs/seat-digest.md
...
## menno420/pokemon-mod-lab — docs/seat-digest.md
...
- `any` · **Environment / Project creation**: owner-click actions in the console — queue them as structured owner asks, never wait silently. Routine/schedule creation…
- `any` · **GraphQL API quota**: tight — batch queries and prefer the REST-backed MCP tools for bulk reads.
- `any` · **this bare hourly-wake container has no ARM/mGBA build toolchain pre-installed** (`arm-none-eabi-gcc` absent, no `agbcc` checkout, no `mgba*` binary anywhere…
