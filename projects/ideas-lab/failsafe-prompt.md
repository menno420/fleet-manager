...
(STATELESS, D-9) — find old ids in: this lane's heartbeat + fleet-manager telemetry/triggers-snapshot.json; a prior coordinator may still be LIVE — confirm its chat is archived BEFORE deleting its failsafe; THIS lane's ids only; plus ids the heartbeat
