...
# Ideas Lab — Custom Instructions (registry copy, prompts v3.4)
...
> char-count: 7,897 chars = the paste body below the marker, trailing
> newline excluded (CHARACTERS — the fleet budget basis; raw UTF-8 bytes
> 7,978) · hard cap 8,000 chars: PASS.
