...
(STATELESS, D-9) — find old ids in: the money-seat heartbeats (trading status carries the trigger-id records); the weekly grading cron is a BUSINESS cron — rebound per step 4, kept alive; plus ids the heartbeat
