...
> Version lineage: v7 (2026-07-13) supersedes the v3.3 registry sync copy.
...
> char-count: 7,915 chars = the paste body below the marker, trailing
> newline excluded (CHARACTERS — the fleet budget basis; raw UTF-8 bytes
> 7,996) · hard cap 8,000 chars: PASS.

<!-- registry-header-end -->
v3.5 venture-lab CI — dictionary+router. DRIFT CHECK: quote this line on ask; older than fm:projects/venture-lab/instructions.md = stale.
...
- **trading squash exception** — RETIRED-superseded: the trading enabler self-lands green claude/*; never revive it. -> trading docs/CAPABILITIES.md
- **triggers die at archive** — record trigger ids in the heartbeat each handover. -> venture docs/PLATFORM-LIMITS.md

## Routes
CORE=fm:docs/prompts/v3/custom-instructions-core.md (riders) · UNIV=fm:projects/UNIVERSAL.md (owner grant; never edit) · STARTUP=fm:projects/venture-lab/coordinator-prompt.md · ender=fm:docs/prompts/v3/session-ender.md. Deep-route: docs/conventions.md -> per-repo CONSTITUTION.md.
