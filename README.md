...
[`docs/prompts/`](docs/prompts/README.md) *(mixed — four live exceptions:
...
[the curious-research review prompt](docs/prompts/2026-08-07-curious-research-external-review.md)
and [the 2026-09-02 review-sitting continuation prompt](docs/prompts/2026-09-02-step-by-step-review-sitting.md))*.
